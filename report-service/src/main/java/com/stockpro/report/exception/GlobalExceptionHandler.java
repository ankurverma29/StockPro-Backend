...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(ReportNotFoundException exception, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleProcessingFailure(RuntimeException exception, HttpServletRequest request) {
