...
import com.stockpro.service.AuthService;
...
public class AuthResource {
	...
	public ResponseEntity<ApiResponse<AuthResponse>> registerRequest(@RequestBody RegisterRequest registerRequest) {
	...
	@SecurityRequirement(name = "bearerAuth")
	@PreAuthorize("hasRole('ADMIN')")
	@Operation(summary = "Admin: Update a user")
	public ResponseEntity<ApiResponse<UserResponseDTO>> updateUser(@PathVariable Long id, @RequestBody AdminUpdateUserRequest request) {
	...
	public ResponseEntity<ApiResponse<AuthResponse>> logout() {
		...
		return ResponseEntity.ok(ApiResponse.success(response, "Logged out successfully"));
	}
